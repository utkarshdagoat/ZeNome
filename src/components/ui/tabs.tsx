  ...
  "inline-flex items-center justify-center",
  {
    variants: {
      variant: {
        ...
        outline: "px-3 py-1.5 text-sm font-medium ring-offset-background transition-all border-b-2 data-[state=active]:border-primary data-[state=active]:font-bold data-[state=active]:text-foreground text-muted-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
